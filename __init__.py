...
APPLICATION_ID = '96dGiIHwrajox3Ms0IbTBwzBl4jQe52US5P1KPyb'
REST_API_KEY = 'fQzHJF4gR8rm6Kto1t6LpuP3OSYg5rGqt27d2YjW'
...
class ParseBase(object):
    ...
    def execute(cls, uri, http_verb, extra_headers=None, **kw):
        ...
        if http_verb == 'GET' and data:
            url += '?%s' % urllib.parse.urlencode(kw)
            data = None
        ...
        #print(json.loads(response.read().decode(encoding)))
